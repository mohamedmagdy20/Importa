...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">@lang('lang.add') @lang('lang.transpot') </h4>
            
            <form method="post" action="{{ route('transport.store') }}"  class="needs-validation"  novalidate >
                @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-11">
                    <input name="container_out_date" class="form-control" type="datetime-local" id="release_date" placeholder="@lang('lang.enter') @lang('lang.date')" required>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-11">
                    <input name="arrive_date" class="form-control" type="datetime-local" id="release_date" placeholder="@lang('lang.enter') @lang('lang.date')" required>
                    @error('arrive_date')
                    <span class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-11">
                    <input name="leave_date" class="form-control" type="datetime-local" id="release_date" placeholder="@lang('lang.enter') @lang('lang.date')" required>
                    @error('leave_date')
                    <span class="text-danger"> {{ $message }} </span>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-11">
                    <input name="container_arrive_date" class="form-control" type="datetime-local" id="release_date" placeholder="@lang('lang.enter') @lang('lang.date')" required>
